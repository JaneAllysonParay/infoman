...
<?php
$sql = "SELECT * FROM tblstudent where fldstudentnumber='$vsearch' || fldlastname= '$vsearch' || fldfirstname= '$vsearch' || fldmiddlename= '$vsearch' || fldprogramofstudy= '$vsearch' order by fldindex desc";
